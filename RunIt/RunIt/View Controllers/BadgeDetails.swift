...
class BadgeDetailsEarnedCell: UITableViewCell {
...
extension BadgeDetails {
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		if sectionArray[indexPath.section].kind == .title {
			...
			let cell = tableView.dequeueReusableCell(withIdentifier: "BadgeDetailsEarnedCell", for: indexPath) as! BadgeDetailsEarnedCell
			...
			cell.subTitle.text = formatter.string(from: currentRun.run.date!)
